 ...
 * @method string getMicrosoftCalendarId()
 * @method void setMicrosoftCalendarId(string $microsoftCalendarId)
 * @method string getMicrosoftEventId()
 * @method void setMicrosoftEventId(string $microsoftEventId)
